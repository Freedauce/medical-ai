        ...
        <div className="flex h-[calc(100vh-120px)] flex-col">
            ...
            {messages.length > 6 && !showReport && !suggestedDoctor && (
                <motion.button
                    ...
                    className="fixed top-20 right-4 z-50 flex items-center gap-2 rounded-full bg-gradient-to-r from-orange-500 to-red-500 px-5 py-3 text-white font-semibold shadow-2xl sm:hidden"
                >
